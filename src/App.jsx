  ...
  return (
    <section className="card scada-placeholder-wrap">
      <div className="placeholder-head">
        ...
        <span>Tempatkan diagram proses WTP Anda di sini</span>
      </div>

      <svg
        className="scada-svg-placeholder"
        viewBox="0 0 1200 420"
        role="img"
        aria-label="Placeholder SVG skema SCADA"
      >
        <defs>
        ...
        <rect x="20" y="20" width="1160" height="380" rx="12" fill="#1d2430" stroke="#3e4d63" strokeWidth="2" />

        <rect x="80" y="140" width="220" height="130" rx="8" fill="#2d5b8f" stroke="#8ac2ff" />
        <text x="190" y="205" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="700">RAW WATER</text>

        <rect x="470" y="140" width="260" height="130" rx="8" fill="#3a6f4d" stroke="#97e9af" />
        <text x="600" y="205" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="700">WTP PROCESS</text>

        <rect x="900" y="140" width="220" height="130" rx="8" fill="#6c4b84" stroke="#d2a8f2" />
        <text x="1010" y="205" textAnchor="middle" fill="#fff" fontSize="20" fontWeight="700">CLEAN TANK</text>

        <line x1="300" y1="205" x2="470" y2="205" stroke="#78b7ff" strokeWidth="6" markerEnd="url(#arrow)" />
        <line x1="730" y1="205" x2="900" y2="205" stroke="#78b7ff" strokeWidth="6" markerEnd="url(#arrow)" />

        <text x="600" y="348" textAnchor="middle" fill="#9fb6d6" fontSize="16">
